...
namespace DemoMvcApp.Controllers
{
    public class TournamentController : Controller
    {
        ...
        {
            List<TournamentDisplayViewModel> tournament = new List<TournamentDisplayViewModel>();
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                tournament = JsonConvert.DeserializeObject<List<TournamentDisplayViewModel>>(result);
            }
        ...
        public async Task<IActionResult> CreateorEdit(long id = 0)
        {
            ...
            else
            {
                ...
                return View(response.Content.ReadAsAsync<TournamentEditViewModel>().Result);
            }           
        }
